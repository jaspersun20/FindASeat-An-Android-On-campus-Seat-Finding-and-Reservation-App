                                    ...
                                    dreference.addListenerForSingleValueEvent(new ValueEventListener() {
                                        ...
                                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                                            ...
                                            for (DataSnapshot childSnapshot: snapshot.child("users").child(userID).child("Reservation").getChildren()) {
                                                ...
                                                Log.d("STTTTATTTTTTTUS111111", String.valueOf(status1));

                                                if (reservation_Date.equals(date1) && timeSlotLabel.equals(time1) && status1 == 1) {
                                                    isconflict = true;
                                                }
                                            }
                                            Log.d("conflict status", String.valueOf(isconflict));
                                            ...
                                            Log.d("reach maximum", String.valueOf(reach_maximum));
                                            Log.d("reservation number", String.valueOf(num_reservation_in_that_day));
                                            ...
                                            if(reach_maximum.equals(true)){
                                                new AlertDialog.Builder(Reservation.this)
                                                        .setTitle("WARNING!!!")
                                                        .setMessage("You have reached the maximum hour of reservation!!")
                                                        .show();
                                                return;
                                            }
                                    ...
                                    dreference.addListenerForSingleValueEvent(new ValueEventListener() {
                                        ...
                                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                                            ...
                                            for (DataSnapshot childSnapshot: snapshot.child("users").child(userID).child("Reservation").getChildren()) {
                                                ...
                                                Log.d("STTTTATTTTTTTUS1222222", String.valueOf(status2));
...
//    public void getCurrentAvailability(int )
